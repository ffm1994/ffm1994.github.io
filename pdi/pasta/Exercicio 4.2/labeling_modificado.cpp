...
int main(int argc, char** argv){
  ...
  // Aplica floodfill no ponto inicial para tirar todas as bolhas que tocam a margem e ela mesma
  floodFill(image, p, 0);

  //Aplica floodfill para criar um plano de fundo com valor diferente dos que estao nos buracos das bolhas
  floodFill(image, p, 1);
  ...
  // Fazer uma busca dos objetos com buracos e marcar como possuiBuraco 
  for (int x = 0; x < height; x++) 
  {
    for (int y = 0; y < width; y++) 
    {
